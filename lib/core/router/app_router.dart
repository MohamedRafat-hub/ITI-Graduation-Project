...
import 'package:graduation_project/features/aiFinder/domain/entities/gift_request_entity.dart';
import 'package:graduation_project/features/aiFinder/presentation/cubits/ai_recommendation_cubit/ai_recommendation_cubit.dart';
import 'package:graduation_project/features/aiFinder/presentation/views/gift_finder_input_page.dart';
import 'package:graduation_project/features/aiFinder/presentation/views/gift_recommentation_result_page.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return BlocProvider(
            create: (_) =>
                getIt<AiRecommendationCubit>()..fetchRecommendations(request),
      ...
      GoRoute(
        path: RoutesManager.wishlistPath,
        name: RoutesManager.wishlistName,
